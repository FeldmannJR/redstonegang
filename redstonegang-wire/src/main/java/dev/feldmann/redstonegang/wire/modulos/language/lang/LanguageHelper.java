...
package dev.feldmann.redstonegang.wire.modulos.language.lang;

import dev.feldmann.redstonegang.wire.modulos.language.LangUtils;
import dev.feldmann.redstonegang.wire.modulos.language.lang.convert.*;
import dev.feldmann.redstonegang.wire.modulos.language.lang.convert.*;
import dev.feldmann.redstonegang.wire.modulos.language.locale.LocaleHelper;
...
public class LanguageHelper {
    ...
    public static String getItemDisplayName(ItemStack item) {
        return getItemDisplayName(item, LangUtils.defaultLanguage);
    }
    ...
    public static String getShortItemName(ItemStack it) {
        if (it != null && it.getItemMeta() != null && it.getItemMeta().hasDisplayName()) {
            return it.getItemMeta().getDisplayName();
        }
        String name = getItemName(it, LangUtils.defaultLanguage);
        name = name.replace("Bloco de ", "■ ");
        name = name.replace("Espada de ", "⚔ ");

        return name;
    }

    public static String getItemName(ItemStack it) {
        return getItemName(it, LangUtils.defaultLanguage);
    ...
    public static String getEntityName(Entity entity) {
        return translateToLocal(getEntityUnlocalizedName(entity), LangUtils.defaultLanguage);
    }
    ...
    public static String getEntityName(EntityType entityType) {
        return translateToLocal(getEntityUnlocalizedName(entityType), LangUtils.defaultLanguage);
    }
    ...
    public static String getEnchantmentName(Enchantment enchantment) {
        return getEnchantmentName(enchantment, LangUtils.defaultLanguage);
    }
    ...
    public static String getEnchantmentDisplayName(Enchantment enchantment, int level) {
        String name = getEnchantmentName(enchantment, LangUtils.defaultLanguage);
        String enchLevel = getEnchantmentLevelName(level, LangUtils.defaultLanguage);
        return name + (enchLevel.length() > 0 ? " " + enchLevel : "");
    }
